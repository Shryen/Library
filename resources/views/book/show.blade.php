<x-layout>
    <x-section class="max-w-4xl">
        ...
        <div>
            ...
            @endguest
            <div class="text-lg pl-2 mt-5 flex">
                <p>Rates: {{ $book->rates->avg('rate') }}</p>
                <svg xmlns="http://www.w3.org/2000/svg"
                        fill="yellow" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-7">
                ...
                @else
                    <form action="/book/{{ $book->slug }}/rates" method="POST" class="text-sm text-red-500 pl-2 mt-5">
                        ...
                        <div class="flex">
                            ...
                            <label for="5"><svg xmlns="http://www.w3.org/2000/svg" fill=""
