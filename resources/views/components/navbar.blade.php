                ...
                <div class="relative ml-3" x-data="{ show: false }" @click.away ="show=false">
                    <div>
                        <button @click="show = !show" type="button"
                            ...
                            @auth
                                <img class="h-12 rounded-full" src="{{ asset('storage/' . auth()->user()->avatar) }}"
                                    alt="">
                            @endauth
                        </button>
                    </div>
            ...
            -->
                    @auth
                        <div x-show="show"
                            ...
                            <x-dropdown-link href="/profile">My Profile</x-dropdown-link>
                            <x-dropdown-link href="/orders">My Orders</x-dropdown-link>
                            @admin
